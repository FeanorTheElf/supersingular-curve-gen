...
\section{Division polynomial idea}
Consider the $n$-th division polynomial
\begin{equation*}
    \psi_n := n \sqrt{\prod_{(x, y) \in E[n] \setminus \{ O \}} (X - x)} \in k[E]
\end{equation*}
If $n$ is odd, for each $(x, y) \in E[n]$ we also have the point $(x, -y) \in E[n]$, and so the root exists.
If $n$ is even, this holds for all points $(x, y) \in E[n] \setminus E[2]$.
However, the x-coordinates of the three points of $E[2] \setminus \{O\}$ multiply to the three roots of $x^3 + Ax + B$, and so the root exists in $k[E]$ since $y^2 = x^3 + Ax + B$.

We instead work with what I call the short division polynomial
\begin{equation*}
    \phi_n := n \prod_{(x, y), (x, -y) \in E[n] \setminus E[2]} (X - x) \in k[X]
\end{equation*}
which has the advantage that it is univariate.
We have the recursive representation
\begin{align*}
    \phi_0 &= 0 \\
    \phi_1 &= 1 \\
    \phi_2 &= 2 \\
    \phi_3 &= 3x^4 + 6Ax^2 + 12Bx - A^2 \\
    \phi_4 &= 4x^6 + 20Ax^4 + 80Bx^3 - 20A^2x^2 - 16ABx - 32B^2 - 4A^3 \\
    \phi_{2m} &= \frac 1 2 \phi_m (\phi_{m + 2} \phi_{m - 1}^2 - \phi_{m - 2} \phi_{m + 1}^2) \\
    \phi_{2m + 1} &= \begin{cases}
        \phi_{m + 2} \phi_m^3 (x^3 + Ax + B) - \phi_{m - 1}\phi_{m + 1}^3 & \text{if $m$ is even} \\
        \phi_{m + 2} \phi_m^3 - \phi_{m - 1} \phi_{m + 1}^3 (x^3 + Ax + B) & \text{if $m$ is odd}
    \end{cases}
\end{align*}
For reference, I include the first short division polynomials here.
\begin{align*}
    \phi_5 =& (-256 B^4 - 32 A^3B^2 + A^6) + (-640 AB^3 - 100 A^4B) x \\ 
        &+ (-240 A^2B^2 - 50 A^5) x^2 + (-1600 B^3 - 80 A^3B) x^3 \\
        &+ (-1920 AB^2 - 125 A^4) x^4 - 696 A^2B x^5 + (-240 B^2 - 300 A^3) x^6 \\
        &+ 240 AB x^7 - 105 A^2 x^8 + 380 B x^9 + 62 A x^{10} + 5 x^{12} \\
    \phi_6 =& (1024 A^2B^4 + 192 A^5B^2 + 6 A^8) + (-12288 B^5 - 512 A^3B^3 \\ 
        &+ 192 A^6B) x + (-27648 AB^4 - 3072 A^4B^2 + 144 A^7) x^2 \\
        &+ (-25088 A^2B^3 - 3584 A^5B) x^3 + (-10752 B^4 - 8064 A^3B^2 - 728 A^6) x^4 \\
        &+ (-32256 AB^3 - 6720 A^4B) x^5 + (-5376 A^2B^2 - 2576 A^5) x^6 \\
        &+ (-44544 B^3 + 1536 A^3B) x^7 + (-39744 AB^2 - 1884 A^4) x^8 - 9152 A^2B x^9 \\
        &+ (-5376 B^2 - 2576 A^3) x^{10} - 728 A^2 x^{12} + 1344 B x^{13} \\
        &+ 144 A x^{14} + 6 x^{16} \\
    \phi_7 =& (65536 B^8 + 24576 A^3B^6 + 3328 A^6B^4 + 160 A^9B^2 - A^{12}) \\ 
        &+ (229376 AB^7 + 64512 A^4B^5 + 7168 A^7B^3 + 392 A^{10}B) x \\
        &+ (544768 A^2B^6 + 96768 A^5B^4 + 3696 A^8B^2 + 196 A^{11}) x^2 \\
        &+ (-802816 B^7 + 831488 A^3B^5 + 152320 A^6B^3 + 1680 A^9B) x^3 \\
        &+ (-3039232 AB^6 + 394240 A^4B^4 + 134400 A^7B^2 + 1302 A^{10}) x^4 \\
        &+ (-3698688 A^2B^5 - 168448 A^5B^3 + 57288 A^8B) x^5 \\
        &+ (-2809856 B^6 - 2293760 A^3B^4 - 190400 A^6B^2 + 14756 A^9) x^6 \\
        &+ (-7127040 AB^5 - 1314560 A^4B^3 - 53824 A^7B) x^7 \\
        &+ (-7069440 A^2B^4 - 831936 A^5B^2 + 15673 A^8) x^8 \\
        &+ (-1555456 B^5 - 3727360 A^3B^3 - 425712 A^6B) x^9 \\
        &+ (-3293696 AB^4 - 1192800 A^4B^2 - 42168 A^7) x^{10} \\
        &+ (-2603776 A^2B^3 - 608160 A^5B) x^{11} \\
        &+ (-928256 B^4 - 297472 A^3B^2 - 111916 A^6) x^{12} \\
        &+ (-2132480 AB^3 - 161840 A^4B) x^{13} + (-615360 A^2B^2 - 82264 A^5) x^{14} \\
        &+ (-829696 B^3 - 31808 A^3B) x^{15} + (-571872 AB^2 - 35231 A^4) x^{16} \\
        &- 92568 A^2B x^{17} + (-42896 B^2 - 19852 A^3) x^{18} - 112 AB x^{19} \\
        &- 2954 A^2 x^{20} + 3944 B x^{21} + 308 A x^{22} + 7 x^{24}
\end{align*}
...
\end{proof}
An example of ordinary curves that still yield joint roots of both polynomials above is displayed in Figure~\ref{fig:example_odd_crater_fp}

\begin{figure}
    \includegraphics{example_odd_crater_fp.png}
    \caption{\label{fig:example_odd_crater_fp} A 2-isogeny vulcano over $\F_{101^2}$ that has an odd crater with curves defined over $\F_p$ (in the plot, have $\alpha = z$).}
\end{figure}
...
Now to the question whether we really have to choose $n = \Theta(\log_l(p))$, resp. how many ordinary $l$-isogeny vulcanos have $n$ levels over $\F_{p^2}$ for $n < \log_l(p)$.
This is answered by the next theorem.
\begin{theorem}
    Let $l$ and $p$ be distinct primes with $p \neq 2$ and let $r \in \mathbb{N}$.
    Consider the number $n$ of endomorphism rings $\O$ of ordinary curves defined over $\F_{p^2}$ with $\pi \in \Z + l^r\O$, where $\pi$ is the $p^2$-Frobenius endomorphism of $\O$.
    Then
    \begin{equation*}
        \Bigl\lfloor \frac p {l^{2r}} \Bigr\rfloor \leq n \leq \Bigl\lfloor \frac {4p(p + 1)} {l^{3r}} \Bigr\rfloor
    \end{equation*}
    ...
    Under GRH, we then get for $p \geq l^{2r}$ that
    \begin{equation*}
        c_1\left( \frac {p^2} {l^{3r} \log\log(p)} \right) \leq N \leq c_2\left( \frac {p^2\log(p)^2} {l^{3r}} \right)
    \end{equation*}
    where $c_1, c_2 > 0$ are constants.
\end{theorem}
\begin{proof}
    First, we show the lower bounds.
    Note that there are $\lfloor p/l^{2r} \rfloor$ different integers $a$ with $0 < al^{2r} < p$ (clearly $l^{2r} \notdivides p$).
    For each of them, consider $D = 4al^{2r}(al^{2r} - p)$.
    Clearly $D$ is a fundamental discriminant, as $D \equiv 0 \mod 4$.
    We have
    \begin{equation*}
        (p - 2al^{2r})^2 - D \cdot 1^2 = p^2 - 4pal^{2r} + 4a^2l^{4r} - 4a^2l^{4r} + 4pal^{2r} = p^2
    \end{equation*}
    Thus the imaginary quadratic order $\O$ with discriminant $D$ contains a nontrivial element of norm $p^2$, which must be $\pi$.
    In particular, the imaginary quadratic order $\O_0$ with discriminant $d := D/l^{2r}$ satisfies $\O = \Z + l^r\O_0$ as $[\O_0 : \O]^2 = d(\O)/d(\O_0) = l^r$
    Therefore we see that $\pi \in \Z + l^r\O_0$.
    ...
    Under GRH, the class number of an imaginary quadratic number field is lower bounded by
    \begin{equation*}
        h(d) \geq \frac {\sqrt{|d|}} {\log\log|d|} \Theta(1)
    \end{equation*}
    Hence, the total number of curves is lower bounded by
    \begin{align*}
        &\Theta(1) \sum_{1 \leq a \leq \lfloor p/l^{2r} \rfloor} h(4a(al^{2r} - p)) \geq \Theta(1) \sum_{1 \leq a \leq \lfloor p/l^{2r} \rceil} \frac {\sqrt{4a|al^{2r} - p|}} {\log\log|4a(al^{2r} - p)|} \\
        =& \Theta(1) l^r \sum_{1 \leq a \leq \lfloor p/l^{2r} \rfloor} \frac {\sqrt{a} \sqrt{p/l^{2r} - a}} {\log(\log(4) + \log(al^{2r}) + \log(p - al^{2r}))} \\
        \geq& \Theta(1) \frac {l^r} {\log(\log(4) + 2\log(p/2))} \sum_{1 \leq a \leq \lfloor p/l^{2r} \rfloor} \sqrt{a} \sqrt{p/l^{2r} - a} \\
        =& \Theta(1) \frac {l^r} {\log\log(p)} \int_0^{p/l^{2r}} \sqrt{a} \sqrt{p/l^{2r} - a} \ da \\
        =& \Theta(1) \frac {p^2} {l^{2r} \log\log(p)} \int_0^1 \sqrt{x(1 - x)} dx - \Theta(1) = \Theta\left( \frac {p^2} {l^{3r} \log\log(p)} \right)
    \end{align*}
    We assume that $p \geq l^{2r}$ when estimating the sum by the integral.

    Now to the upper bounds.
    Consider an endomorphism ring $\O_0$ such that $\O := \Z + l^r\O_0$ contains the $p^2$-Frobenius $\pi$.
    Then
    \begin{equation*}
        \Z[\pi] \subseteq \O \subseteq \O_0
    \end{equation*}
    and so $D := d(\Z[\pi]) = a^2l^{2r}d(\O_0)$.
    Furthermore, if $t$ is the trace of $\pi$, we find $D = t^2 - 4p^2 = (t - 2p)(t + 2p)$.
    Hence
    \begin{equation*}
        a^2l^{2r}d(\O_0) = (t - 2p)(t + 2p)
    \end{equation*}
    Unless $l = 2$, $l$ cannot divide both $t - 2p$ and $t + 2p$.

    If $l^{2r} \divides t + 2p$, then $t \in \{ l^{2r} - 2p, 2l^{2r} - 2p, ..., kl^{2r} - 2p \}$ where $k = \lfloor 2p/l^{2r} \rfloor$.

    If $l^{2r} \divides t - 2p$, then $t \in \{ 2p - (k + 1)l^{2r}, 2p - (k + 2)l^{2r}, ..., 2p - (2k + 1)l^{2r} \}$.
    \\
    In particular, there are at most $2k + 1$ different choices for $t$.
    For a given $t$, there are now at most
    \begin{equation*}
        \sqrt{\frac {|t^2 - 4p^2|} {l^{2r}}} \leq \sqrt{\frac {4p^2} {l^{2r}}} = \frac {2p} {l^r}
    \end{equation*}
    choices for $a$, which then uniquely determines $d(\O_0)$.
    The total number of possibilities for $d(\O_0)$ is thus
    \begin{equation*}
        (2k + 1) \frac {2p} {l^r} \leq \frac {4p(p + 1)} {l^{3r}}
    \end{equation*}
    ...
    \begin{align*}
        &\sum_{1 \leq i \leq k} \quad \sum_{a^2 \divides ((il^{2r} - 2p)^2 - 4p^2)/l^{2r}} h\Biggl( \frac {(il^{2r} - 2p)^2 - 4p^2} {a^2l^{2r}} \Biggr) \\
        &+ \sum_{k + 1 \leq i \leq 2k + 1} \quad \sum_{a^2 \divides ((2p - il^{2r})^2 - 4p^2)/l^{2r}} h\Biggl( \frac {(2p - il^{2r})^2 - 4p^2} {a^2l^{2r}} \Biggr) \\
        \leq& O(\log(4p^2/l^{2r})) \Biggl( \sum_{1 \leq i \leq k} \sqrt{\frac {4p^2 - (il^{2r} - 2p)^2} {l^{2r}}} \sum_{a^2 \divides ((il^{2r} - 2p)^2 - 4p^2)/l^{2r}} \frac 1 a \\
        &+ \sum_{k + 1 \leq i \leq 2k + 1} \sqrt{\frac {4p^2 - (2p - il^{2r})^2} {l^{2r}}} \sum_{a^2 \divides ((2p - il^{2r})^2 - 4p^2)/l^{2r}} \frac 1 a \Biggr)
    \end{align*}
    Note that
    \begin{align*}
    ...
    \begin{align*}
        &O(\log(4p^2/l^{2r})) \Biggl( \sum_{1 \leq i \leq k} \sqrt{ \frac {4p^2 - (il^{2r} - 2p)^2} {l^{2r}}} \quad \log\left( \frac {4p^2 - (il^{2r} - 2p)^2} {l^{2r}} \right) \\
        &+ \sum_{k + 1 \leq i \leq 2k + 1} \sqrt{ \frac {4p^2 - (2p - il^{2r})^2} {l^{2r}}} \quad \log\left( \frac {4p^2 - (2p - il^{2r})^2} {l^{2r}} \right) \Biggr) \\
        \leq& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \sum_{1 \leq i \leq k} \sqrt{4p^2 - (il^{2r} - 2p)^2} + \sum_{k + 1 \leq i \leq 2k + 1} \sqrt{4p^2 - (2p - il^{2r})^2} \Biggr) \\
        =& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \int_0^k \sqrt{4p^2 - (xl^{2r} - 2p)^2} dx + \int_{k + 1}^{2k + 2} \sqrt{4p^2 - (xl^{2r} - 2p)^2} dx \Biggr) \\
        \leq& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \int_0^k \sqrt{4p^2 - (xl^{2r} - 2p)^2} dx + \int_{k}^{2k} \sqrt{4p^2 - (xl^{2r} - 2p)^2} dx + O(p) \Biggr) \\
        =& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \frac 1 {l^{2r}} \int_0^{2p} \sqrt{4p^2 - (x - 2p)^2} dx + \frac 1 {l^{2r}} \int_{2p}^{4p } \sqrt{4p^2 - (2p - x)^2} dx + O(p)\Biggr) \\
        =& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \frac 1 {l^{2r}} \int_{-2p}^0 \sqrt{4p^2 - x^2} dx + O(p) \Biggr) \\
        =& \frac {O(\log(p/l^r)^2)} {l^r} \Biggl( \frac {4p^2} {l^{2r}} \int_{-1^0} \sqrt{1 - x^2} \Biggr) = O\left( \frac {p^2\log(p/l^r)^2} {l^{3r}} \right)
    \end{align*}
    This shows the claim.
\end{proof}

Further, note that the bound $\log_l(p)/2$ for the maximum number of levels over $\F_{p^2}$ is better than the one used by Sutherland in his paper\footnote{However, I have later found the improved bound here \cite{fp_supersingularity_tests}.}.
...
Here is an idea how to compute this in special cases.
Make the following assumptions:
\begin{itemize}
    \item Assume that $p^2 - 1$ has a divisor $n$ of size approximately $p^{3/2}$ such that $n \mod p$ is small.
    \item Assume that the j-invariants $j \in \F_{p^2} \setminus \F_p$ with two distinct $\F_p$-neighbors are equally distributed in the cosets of $\F_{p^2}^*$ modulo the subgroup of order $\frac {p^2 - 1} n$.
\end{itemize}
Now choose a random $h \in \F_{p^2}^*$ and consider a random root in $\F_p$ of the ideal
\begin{equation*}
    \langle \Phi_2(u, x + \delta y), \Phi_2(w, x + \delta y), \Phi_4(u, w), (x + \delta y)^n = h^n \rangle
\end{equation*}
If $x, y$ are assumed to be in $\F_p$, then we can also simplify the equation, as
\begin{align*}
    &(x + \delta y)^n = \sum_{i = 0}^n \binom{n}{i} x^i (\delta y)^{n - i} \\
    =& \sum_{i = 0}^{\text{$n$ mod $p$}} \sum_{j = 0}^{\lfloor n/p \rfloor} \binom{n}{i + jp} x^{i + jp} y^{n - i - jp} \delta^{n - i - jp} \\
    =&\sum_{i = 0}^{\text{$n$ mod $p$}} x^i y^{(\text{$n$ mod $p$}) - i} \sum_{j = 0}^{\lfloor n/p \rfloor} \binom{n}{i + jp} \delta^{n - i - jp}
\end{align*}
Note that by our assumptions above, this is a polynomial-sized polynomial.

In other words, we need to find a random $\F_p$-root of a 1-dimensional variety defined over $\F_{p^2}$.
Since we have a small constant number of variables, Groebner basis techniques and the like should be available.

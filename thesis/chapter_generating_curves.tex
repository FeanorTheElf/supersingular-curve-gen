...
\begin{question}
    ...
    How large is the fraction of supersingular roots of $\Phi_n(X, X^p)$ resp. of $f_{p, n, m}$?
...
\begin{question}
    ...
    How can we efficiently compute $f_{p, n, m}$, especially since $p$ and possibly $n$ resp. $m$ are exponentially large?
...
Finally, we present our first main result, which answers the $\F_{p^2}$-part of Question~\ref{question:first} for a subset of the $m$ and $n = l^e$.

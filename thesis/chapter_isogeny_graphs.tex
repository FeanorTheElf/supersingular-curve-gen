...
\begin{remark}
    ...
    Hence, $G$ is not a subgraph of $\Gamma_l(\F_p)$, and it turns out that its structure is more similar to ordinary isogeny volcanos than to a supersingular expander graph.
\end{remark}

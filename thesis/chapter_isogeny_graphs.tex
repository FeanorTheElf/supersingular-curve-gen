...
Hence, an isogeny $\phi: E \to E'$ being cyclic is equivalent to the fact that $\phi$ does not factor through $[m]$ for any integer $m \geq 2$.
...
\begin{proof}
    ...
    An isogeny $E \to E'$ is corresponds to polynomials (more precisely, elements of $k[E]$) satisfying the equation of $E'$.

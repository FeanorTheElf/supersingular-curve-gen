...
In particular, various cryptographic primitives \cite{torsion_point_problem1, torsion_point_problem2} currently require a trusted setup step, which another way of generating initial curves would be found.
